...
public class SparkWindowRankFunction {
    ...
    public static void main(String[] args)
    {
        ...
        Dataset<Row> df2 = df.
                withColumn("rank", rank().over(divWindowSpec)).
                withColumn("dense_rank", dense_rank().over(divWindowSpec)).
                withColumn("row_number", row_number().over(divWindowSpec)).
                withColumn("percent_rank", percent_rank().over(divWindowSpec));
