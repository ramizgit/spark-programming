...
public class SparkWindowAggregateFunction {
    ...
    public static void main(String[] args)
    {
        ...
        WindowSpec divWindowSpec = Window.partitionBy(col("division"));

        Dataset<Row> df2 = df.
                withColumn("department_max_salary", max("salary").over(divWindowSpec)).
                withColumn("department_min_salary", min("salary").over(divWindowSpec));
        df2.show();
    }
}
